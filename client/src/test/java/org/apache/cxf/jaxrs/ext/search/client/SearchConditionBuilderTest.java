...
public class SearchConditionBuilderTest {
    ...
    public void testDefault() throws Exception {
        Assert.assertTrue(SearchConditionBuilder.instance() instanceof FiqlSearchConditionBuilder);
    }

    @Test
    public void testFiqlImpl() throws Exception {
        Assert.assertTrue(SearchConditionBuilder.instance("FIQL") instanceof FiqlSearchConditionBuilder);
    }
